...
namespace RemoteProtocol.Game
{
    public partial class KBC : Form
    {
...

        {
            ...
            Question_box.Text = "In ce an a fost fondata societatea Junimea?";
            OPT_1.Text = "1863";
            OPT_2.Text = "1843";
            OPT_3.Text = "1945";
            OPT_4.Text = "1900";
        ...
        {
            if (Question_box.Text.Equals("In ce an a fost fondata societatea Junimea?"))
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //Server.Instance.SendMessage(new TestRequest("its working"),new Joc);
        }
    }
}
